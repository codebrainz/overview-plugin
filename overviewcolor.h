...
void           overview_color_from_gdk_color (OverviewColor       *color,
                                              ...
                                              gdouble              alpha);
void           overview_color_to_gdk_color   (OverviewColor       *color,
                                              GdkColor            *gcolor);
#if GTK_CHECK_VERSION (3, 0, 0)
void           overview_color_from_rgba      (OverviewColor       *color,
                                              const GdkRGBA       *rgba);
void           overview_color_to_rgba        (OverviewColor       *color,
                                              GdkRGBA             *rgba);
#endif
void           overview_color_from_int       (OverviewColor       *color,
                                              guint32              abgr,
                                              gboolean             with_alpha);
guint32        overview_color_to_int         (OverviewColor       *color,
                                              gboolean             with_alpha);
gboolean       overview_color_from_keyfile   (OverviewColor       *color,
                                              ...
                                              const gchar         *option,
                                              GError             **error);
gboolean       overview_color_to_keyfile     (OverviewColor       *color,
                                              GKeyFile            *keyfile,
                                              const gchar         *section,
                                              const gchar         *option);
